...
#define Z_MIN_PROBE_PIN 30 //PC7 pin, 5th pin of J23 connector on the UM2 Board
...
//aqee, todo, this doesn't work, use M851 Z-2.7 instead.
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_1_X X_MAX_POS/2
  #define ABL_PROBE_PT_1_Y Y_MAX_POS * 0.8
  #define ABL_PROBE_PT_2_X X_MAX_POS * 0.2
  #define ABL_PROBE_PT_2_Y Y_MAX_POS * 0.2
  #define ABL_PROBE_PT_3_X X_MAX_POS * 0.8
  #define ABL_PROBE_PT_3_Y Y_MAX_POS * 0.2
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 20), (Y_MAX_POS - 20), 120 }
#endif
...
// For more info: https://github.com/Ultimaker/Ultimaker2/tree/master/1249_Ulticontroller_Board_(x1)
//
#define ULTI_CONTROLLER
//aqee, no need for following settings, all are included, see Conditionals_LCD.h
